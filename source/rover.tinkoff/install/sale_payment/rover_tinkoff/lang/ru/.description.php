...
$MESS['SALE_TINKOFF_DESCRIPTION']   = 'https://www.rover-it.me/';
...
$MESS['SALE_TINKOFF_ORDER_STATUS_REFUNDED_NAME']    = 'Статус заказа, по которому сделали возврат';
...
$MESS['SALE_TINKOFF_CANCEL_REFUNDED_ORDER_NAME']    = 'Отменять заказ, по которому сделали возврат';
...
$MESS['SALE_TINKOFF_RECIPIENT_ID_NAME']     = 'Высылать покупателю чек на';
...
$MESS['SALE_TINKOFF_RECIPIENT_ID_both']     = 'телефон и email';
$MESS['SALE_TINKOFF_RECIPIENT_ID_email']    = 'только email';
$MESS['SALE_TINKOFF_RECIPIENT_ID_phone']    = 'только телефон';
...
$MESS['SALE_TINKOFF_NDS_vat18']     = "НДС чека по ставке 18%";
$MESS['SALE_TINKOFF_NDS_vat110']    = "НДС чека по расчетной ставке 10/110";
$MESS['SALE_TINKOFF_NDS_vat118']    = "НДС чека по расчетной ставке 18/118";